...
- **In Memoriam is said where the format is.** The entry page and
  the sheet draw an `IN MEMORIAM` badge after the format, and the year as a
  ...
  operator judging an In Memoriam entry is judging whether it is a deceased
  person's date of death, and could not see the
