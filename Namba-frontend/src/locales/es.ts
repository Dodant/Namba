...
export const ES: Messages = {
  ...
  form: {
    ...
    titlePlaceholder: (section: Section) => ({
      ...
      abbr: 'Objeto volador no identificado',
      calendar: 'Navidad',
    })[section],
    details: 'Detalles',
    ...
    detailsPlaceholder: (section: Section) => ({
      ...
      abbr: 'El término que acuñó la Fuerza Aérea de EE. UU. para lo que no lograba identificar en el cielo.',
      calendar: 'Se celebra el 25 de diciembre, caiga en el día de la semana que caiga.',
    })[section],
