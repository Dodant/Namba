...
export const DE: Messages = {
  ...
  form: {
    ...
    titlePlaceholder: (section: Section) => ({
      ...
      abbr: 'Unbekanntes Flugobjekt',
      calendar: 'Weihnachten',
    })[section],
    details: 'Details',
    ...
    detailsPlaceholder: (section: Section) => ({
      ...
      abbr: 'Der Begriff, den die US-Luftwaffe für alles prägte, was sie am Himmel nicht bestimmen konnte.',
      calendar: 'Wird am 25. Dezember gefeiert, egal auf welchen Wochentag er fällt.',
    })[section],
