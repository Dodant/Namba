...
export type UiLocale = 'en' | 'ko' | 'ja' | 'zh-Hans' | 'es' | 'fr'
...
const MESSAGES = { en: EN, ko: KO, ja: JA, 'zh-Hans': ZH_HANS, es: ES, fr: FR }

const UI_KEY = 'namba.uiLocale'
export const uiLocale = {
  get: (): UiLocale => {
    const saved = localStorage.getItem(UI_KEY)
    if (saved === 'en' || saved === 'ko' || saved === 'ja' || saved === 'zh-Hans' || saved === 'es' || saved === 'fr') return saved
